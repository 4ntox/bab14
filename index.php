...
//panggil dan mendapatkan data session
        ...
        <div class="container-fluid">
            ...
            <div class= "collapse navbar-collapse" id= "navbarSupportedContent">
                ...
                <ul class= "navbar-nav ms-auto mb-2 mg-lg-0">
                    <li class= "nav-item">
                        <a class= "nav-link" aria-current= "page" href= "index.php">Daftar Petugas</a>
                    </li>

                    <li class= "nav-item">
                        <a class= "nav-link" aria-current= "page" href= "registrasi.php">Form Registrasi Petugas</a>
                    </li>
                    ...
                    <li class= "nav-item">
                        <a class= "nav-link" aria-current= "page" href= "logout.php">Logout Petugas</a>
                    </li>
